...
-----------------------------------------------------------------------------------------------------------*/
    ...
    unsigned char* imageData { stbi_load("../img/kemomimi.jpg", &imageWidth, &imageHeight, &nrChannels, 0) };
    if (imageData)
    {
...
//===========================================================================================================
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        trans1 = glm::scale(trans1, glm::vec3(1/globals::ASPECT_RATIO, 1.0f, 1.0f));      // preserve the original aspect ration of the object
        trans1 = glm::translate(trans1, glm::vec3(0.5f, -0.5f, 0.0f));
        trans1 = glm::rotate(trans1, static_cast<float>(glfwGetTime()), glm::vec3(0.0f, 0.0f, 1.0f));
        theShader.setMat4("transform", trans1);
        ...
        trans2 = glm::scale(trans2, glm::vec3(1/globals::ASPECT_RATIO, 1.0f, 1.0f));      // preserve the original aspect ration of the object
        trans2 = glm::translate(trans2, glm::vec3(-0.5f, 0.5f, 0.0f));
        trans2 = glm::scale(trans2, glm::vec3(glm::sin(glfwGetTime()), glm::sin(glfwGetTime()), 1.0f));
        theShader.setMat4("transform", trans2);
