...
int main()
{
    ...
    // set light uniforms
    cube.getShader().setVec4("light.pos_dir",  glm::vec4{ light.getPosition(), 1.0f });     // point light (use position, w = 1.0)
    ...
    cube.getShader().setFloat("light.linear",    0.09f);
    cube.getShader().setFloat("light.quadratic", 0.032f);
