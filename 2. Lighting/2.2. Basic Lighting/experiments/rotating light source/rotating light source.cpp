...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // rotate lightPos
        orbit(lighting::lightPos, glm::vec3(0.4f, 0.3f, -0.5f), cubePosition, 3.0f);            // orbit cube
        // orbit(lighting::lightPos, glm::vec3(0.0f, 1.0f, 0.0f), camera.position, 3.0f);       // lighting orbit camera
        ...
        model_container = glm::scale(model_container, glm::vec3(1.5f));
